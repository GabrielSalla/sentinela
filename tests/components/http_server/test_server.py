...
async def test_configs(admin_cookies):
    ...
    expected_http_server_config = {
        ...
        "commands": {
            "alert_acknowledge": {"enabled": True, "required_role": "user"},
            "alert_lock": {"enabled": True, "required_role": "user"},
            "alert_solve": {"enabled": True, "required_role": "user"},
            "issue_drop": {"enabled": True, "required_role": "admin"},
            "monitor_disable": {"enabled": True, "required_role": "user"},
            "monitor_enable": {"enabled": True, "required_role": "user"},
            "monitor_refresh": {"enabled": True, "required_role": "user"},
            "monitor_register": {"enabled": True, "required_role": "user"},
            "monitor_validate": {"enabled": True, "required_role": "user"},
        },
        "auth": {
